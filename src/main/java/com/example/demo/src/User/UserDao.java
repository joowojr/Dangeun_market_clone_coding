...
public class UserDao {
    ...
    public long createUser(PostUserReq postUserReq){
        String createUserQuery = "INSERT INTO UserInfo (phone_num,nickname) VALUES (?,?)";
        Object[] createUserParams = new Object[]{postUserReq.getPhoneNum(),postUserReq.getNickname()};
